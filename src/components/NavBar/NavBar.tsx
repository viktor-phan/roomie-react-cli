    ...
    <nav className="flex justify-between items-center h-16 bg-black text-white relative shadow-sm p-3 sticky top-0">
      ...
      <div className="flex flex-row align-baseline">
        <input
          type="text"
          placeholder="Search"
          className="w-4/5 h-12 rounded-l-md pl-5"
        />
        <a type="submit" className="w-12 h-12 bg-indigo-500 hover:bg-indigo-400 rounded-r-md flex">
          <Search className="m-auto" />
        </a>
      </div>
      <div className="h-12 w-28 bg-indigo-500 hover:bg-indigo-400 rounded-md pl-4 pr-4 align-middle flex">
